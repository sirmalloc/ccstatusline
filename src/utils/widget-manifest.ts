...
export const WIDGET_MANIFEST: WidgetManifestEntry[] = [
    ...
    { type: 'cost-input', create: () => new widgets.CostInputWidget() },
    { type: 'cost-output', create: () => new widgets.CostOutputWidget() },
    { type: 'cost-cache-write', create: () => new widgets.CostCacheWriteWidget() },
    { type: 'cost-cache-read', create: () => new widgets.CostCacheReadWidget() },
